...
for oo = 1:Nsim
    ...
    % Mean squared error
    MSE(oo,:) = [ vec(beta_true-beta_est_scad)'*vec(beta_true-beta_est_scad) vec(beta_true-beta_est_scad_l)'*vec(beta_true-beta_est_scad_l)...
        vec(beta_true-beta_est_scad_ls)'*vec(beta_true-beta_est_scad_ls) vec(beta_true-beta_est_scad_l_ls)'*vec(beta_true-beta_est_scad_l_ls)...
        vec(beta_true-beta_est_mcp)'*vec(beta_true-beta_est_mcp) vec(beta_true-beta_est_mcp_l)'*vec(beta_true-beta_est_mcp_l)...
        vec(beta_true-beta_est_mcp_ls)'*vec(beta_true-beta_est_mcp_ls) vec(beta_true-beta_est_mcp_l_ls)'*vec(beta_true-beta_est_mcp_l_ls)...
        vec(beta_true-beta_est_lasso)'*vec(beta_true-beta_est_lasso) vec(beta_true-beta_est_lasso_ls)'*vec(beta_true-beta_est_lasso_ls) ];
   oo
end
